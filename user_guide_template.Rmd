...
- Use open sources tools whenever possible to facilitate user accessibility. Where this is not an option, explain why the tool is necessary and point to some possible alternatives
...
### 1.2 Who Is This Data For?
- Intended audience (e.g., policymakers, researchers, advocates, journalists)
- Suggested skill level (beginner / intermediate / advanced)

---

## 2. Key Questions This Data Can Answer
List 5–8 example questions users can explore, in addition to the key question that we will be exploring in this guide.
